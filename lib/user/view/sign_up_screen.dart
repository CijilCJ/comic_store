...
class _SignUpScreenState extends State<SignUpScreen> {
              ...
              child: Column(
                ...
                children: [
                  textFormField(
                    ...
                    "User Name",
                    Icons.person,
                    (v) => v!.isEmpty ? "Required enter a UserName" : null,
                  ),
                  ...
                  textFormField(phoneController, "phone Number", Icons.phone, 
                  (v) {
                    if (v == null || v.isEmpty) {
                      return "Phone number required";
                    } else if (v.length < 10) {
                      return "Enter valid phone (Ex: +91XXXXXXXXXX)";
                    } else {
                      return null;
                    }
                  }),
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      final response = await supabase.from('user_table').insert({
        'id': user!.id,
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Sign Up is faild.Try again")));
      print(e.message);
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
